...
//>>built
define(["exports", "./_commonjsHelpers"], function (ma, R) {
  var B = { exports: {} };
  B.exports;
  (function (C) {
    (function (h) {
      h = h();
      void 0 !== h && (C.exports = h);
    })(function () {
      return {
        load: function (h) {
          function H(a) {
          ...
          function r(a, c, f) {
            var d = c + f;
            for (f = c; a[f] && !(f >= d); ) ++f;
            if (16 < f - c && a.subarray && Z)
              return Z.decode(a.subarray(c, f));
            for (d = ""; c < f; ) {
              var e = a[c++];
              if (e & 128) {
                var g = a[c++] & 63;
          ...
          function p(a) {
            ...
            throw new WebAssembly.RuntimeError(
              "abort(" + a + "). Build with -s ASSERTIONS\x3d1 for more info."
            );
          }
          function ca(a) {
            try {
              if (a == l && K) return new Uint8Array(K);
              if (S) return S(a);
              ...
              if ("function" == typeof c) c(b);
                ...
                "number" === typeof f
                  ? void 0 === c.arg
                    ? q.get(f)()
                    : q.get(f)(c.arg)
                  : f(void 0 === c.arg ? null : c.arg);
              }
            }
          }
          function V(a) {
            function c() {
              if (!O && ((O = !0), (b.calledRun = !0), !ba)) {
                U(ea);
          ...
          if (
            ...
            n = L ? require("path").dirname(n) + "/" : __dirname + "/";
            var ja = function (a, c) {
              F || (F = require("fs"));
              G || (G = require("path"));
              a = G.normalize(a);
            ...
            var S = function (a) {
              ...
              a.buffer || p("Assertion failed: undefined");
              return a;
            };
          ...
          var oa = b.print || console.log.bind(console),
            D = b.printErr || console.warn.bind(console);
          for (w in h) h.hasOwnProperty(w) && (b[w] = h[w]);
          h = null;
          ...
          b.preloadedAudios = {};
          var l = "libtess.wasm";
          l.startsWith("data:application/octet-stream;base64,") || (l = H(l));
          var N = {
              mappings: {},
              buffers: [null, [], []],
              printChar: function (a, c) {
                var f = N.buffers[a];
                0 === c || 10 === c
                  ? ((1 === a ? oa : D)(r(f, 0)), (f.length = 0))
                  : f.push(c);
              },
              varargs: void 0,
              get: function () {
                N.varargs += 4;
                return I[(N.varargs - 4) >> 2];
              },
              getStr: function (a) {
                return a ? r(J, a, void 0) : "";
              },
              get64: function (a, c) {
                return a;
              },
            ...
            pa = {
              ...
              g: function (a) {
                ...
                for (var f = 1; 4 >= f; f *= 2) {
                  ...
                  a: {
                    try {
                      P.grow((e - aa.byteLength + 65535) >>> 16);
                      t(P.buffer);
                      var k = 1;
                      break a;
                    } catch (W) {}
          ...
          (function () {
            ...
            (function () {
              return K ||
                ...
                l.startsWith("data:application/octet-stream;base64,") ||
                l.startsWith("file://") ||
          ...
          b.___wasm_call_ctors = function () {
            return (b.___wasm_call_ctors = b.asm.n).apply(null, arguments);
          };
          b._malloc = function () {
            return (b._malloc = b.asm.o).apply(null, arguments);
          };
          b._free = function () {
            return (b._free = b.asm.p).apply(null, arguments);
          };
          b._triangulate = function () {
            return (b._triangulate = b.asm.r).apply(null, arguments);
          };
          var x = (b.stackSave = function () {
              return (x = b.stackSave = b.asm.s).apply(null, arguments);
            }),
            y = (b.stackRestore = function () {
              return (y = b.stackRestore = b.asm.t).apply(null, arguments);
            }),
            z = (b._setThrew = function () {
              return (z = b._setThrew = b.asm.u).apply(null, arguments);
            }),
            O;
          M = function c() {
            O || V();
          ...
          E.triangulate = (c, f, d) => {
            Y || (Y = m._triangulate);
            var e = m.HEAPF32;
            const g = m.HEAP32.BYTES_PER_ELEMENT;
            var k = e.BYTES_PER_ELEMENT;
            d > la &&
              ((la = d),
              A && (m._free(A), (A = 0)),
              u && (m._free(u), (u = 0)));
            ...
            e.set(c, A / k);
            m.HEAP32.set(f, Q / g);
            c = Y(A, Q, Math.min(f.length, 4e3), 2, u, d / 2);
            e = m.HEAPF32;
            e = e.slice(u / k, u / k + 2 * c);
            k = {};
            k.buffer = e;
            k.vertexCount = c;
            return k;
  ...
  R = (function (C, h) {
    for (var H = 0; H < h.length; H++) {
      ...
      if ("string" !== typeof r && !Array.isArray(r))
        for (const t in r)
          if ("default" !== t && !(t in C)) {
            const p = Object.getOwnPropertyDescriptor(r, t);
            p &&
              Object.defineProperty(
                C,
                t,
                p.get ? p : { enumerable: !0, get: () => r[t] }
              );
          }
    }
  ...
  })({ __proto__: null, default: R.getDefaultExportFromCjs(B) }, [B]);
  ma.libtess = R;
});
