...
const Ot = "" + new URL("app-sm-1-BNwfjq--.png", import.meta.url).href,
  ...
  p = {
    ...
    风功率预测系统: "风功率预测系统",
    CAE模拟仿真平台: "CAE模拟仿真平台",
    风机基础在线检测和疲劳度检测软件: "风机基础在线检测和疲劳度检测软件",
    电力交易辅助决策系统: "电力交易辅助决策系统",
    故障诊断平台: "故障诊断平台",
    AI大模型: "AI大模型",
  },
        ...
        appList: [
          {
            ...
            appname: this.$t("appStore.decision_platform"),
          ...
          },
          {
            ...
            icon3d: jt,
            applink: "/yujing/home",
            appname: this.$t("appStore.fault_warning"),
            type: "iframe",
          ...
          },
          {
            icon: qt,
            icon3d: zt,
            appname: this.$t("appStore.online_and_fatigue_detection"),
          ...
          },
          {
            ...
            icon3d: Jt,
            applink: "",
            appname: this.$t("appStore.hydrometeor_software"),
            category: o.Operation,
          ...
          },
          {
            ...
            icon: Mt,
            icon3d: Yt,
            appname: this.$t("appStore.power_trading_decision_system"),
            category: o.Operation,
          ...
          },
          {
            ...
            icon: $t,
            icon3d: Vt,
            appname: this.$t("appStore.ronds_fault_diagnosis_platform"),
            category: o.Operation,
          ...
          },
          {
            ...
            icon3d: Zt,
            applink: "",
            appname: this.$t("appStore.wind_power_prediction_system"),
            type: p.风功率预测系统,
            category: o.Data,
